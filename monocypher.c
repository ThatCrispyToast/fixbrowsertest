...
static void fe_0(fe h) { size_t i;            FOR(i, 0, 10) h[i] = 0; }
static void fe_1(fe h) { size_t i; h[0] = 1;  FOR(i, 1, 10) h[i] = 0; }

static void fe_copy(fe h,const fe f           ){size_t i; FOR(i,0,10) h[i] =  f[i];      }
static void fe_neg (fe h,const fe f           ){size_t i; FOR(i,0,10) h[i] = -f[i];      }
static void fe_add (fe h,const fe f,const fe g){size_t i; FOR(i,0,10) h[i] = f[i] + g[i];}
static void fe_sub (fe h,const fe f,const fe g){size_t i; FOR(i,0,10) h[i] = f[i] - g[i];}
